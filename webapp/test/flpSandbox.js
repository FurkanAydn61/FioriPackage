		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fioriodatav2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriodatav2-display": {
								"semanticObject": "fioriodatav2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriodatav2",
									"url": sap.ui.require.toUrl("fioriodatav2")
								}
							}
						}
					}
